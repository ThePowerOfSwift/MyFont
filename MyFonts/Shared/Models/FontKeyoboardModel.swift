    ...
    struct ViewModel {
        ...
        static let keyboards: [UserKeyboard] = [
            ...
            UserKeyboard(title: "⓪⑫③⓸",
                         ...
                         locked: false,
                         id: 39),
            UserKeyboard(title: "[̲̅a][̲̅b][̲̅c]",
                         characters: [["[̲̅q]","[̲̅w]","[̲̅e]","[̲̅r]","[̲̅t]","[̲̅y]","[̲̅u]","[̲̅i]","[̲̅o]","[̲̅p]"],
                                      ["[̲̅a]","[̲̅s]","[̲̅d]","[̲̅f]","[̲̅g]","[̲̅h]","[̲̅j]","[̲̅k]","[̲̅l]"],
                                      ["[̲̅z]","[̲̅x]","[̲̅c]","[̲̅v]","[̲̅b]","[̲̅n]","[̲̅m]"]],
                         upperCharacters: [["[̲̅Q]","[̲̅W]","[̲̅E]","[̲̅R]","[̲̅T]","[̲̅Y]","[̲̅U]","[̲̅I]","[̲̅O]","[̲̅P]"],
                                           ["[̲̅A]","[̲̅S]","[̲̅D]","[̲̅F]","[̲̅G]","[̲̅H]","[̲̅J]","[̲̅K]","[̲̅L]"],
                                           ["[̲̅Z]","[̲̅X]","[̲̅C]","[̲̅V]","[̲̅B]","[̲̅N]","[̲̅M]"]],
                         locked: false,
                         id: 40)
